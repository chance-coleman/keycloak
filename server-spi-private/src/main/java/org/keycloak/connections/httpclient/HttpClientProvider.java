...
public interface HttpClientProvider extends Provider {
    ...
    /**
     * Sets a custom retry configuration to be used for subsequent calls to getRetriableHttpClient().
     * <p>
     * This method allows setting a retry configuration that will be used for all subsequent calls
     * to getRetriableHttpClient() that don't explicitly specify a retry configuration.
     * <p>
