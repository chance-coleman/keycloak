 ...
 * making requests. It allows customization of the maximum number of retry attempts,
 * whether to retry on IO exceptions, exponential backoff settings, jitter for backoff times,
 * and connection/socket timeouts.
 * <p>
 * The default configuration is 0 retry attempts (no retries) with retries enabled for IO exceptions if configured,
 * with exponential backoff starting at 1000ms and multiplying by 2.0 for each retry.
 * Jitter is enabled by default with a factor of 0.5 to prevent synchronized retry storms.
 * <p>
 * This configuration is used by the {@link HttpClientProvider#getRetriableHttpClient()}
 * and {@link HttpClientProvider#getRetriableHttpClient(RetryConfig)} methods to create
 ...
 *   <li>{@code retry-io-exception} - Whether to retry on IO exceptions (default: true)</li>
 *   <li>{@code initial-backoff-millis} - Initial backoff time in milliseconds (default: 1000)</li>
 *   <li>{@code backoff-multiplier} - Multiplier for exponential backoff (default: 2.0)</li>
 *   <li>{@code jitter-factor} - Random jitter factor to apply to backoff times (default: 0.5)</li>
 *   <li>{@code use-jitter} - Whether to apply jitter to backoff times (default: true)</li>
 *   <li>{@code connection-timeout-millis} - Connection timeout in milliseconds (default: 10000)</li>
 *   <li>{@code socket-timeout-millis} - Socket timeout in milliseconds (default: 10000)</li>
 * </ul>
 * <p>
 * Example usage:
 * <pre>
...
public class RetryConfig {
     ...
     *
     * @return {@code true} if retries should be attempted on IO exceptions, {@code false} otherwise
     */
     ...
     * <p>
     * The jitter factor determines how much randomness to apply to the backoff time.
    ...
    public static class Builder {
         ...
         * Negative values are allowed but not recommended as they don't make practical sense.
         *
         ...
         * <p>
         * The default value is {@code true}. When set to {@code false}, the client will not
         * retry requests that fail with IO exceptions.
         *
         * @param retryOnIOException {@code true} to retry on IO exceptions, {@code false} otherwise
         * @return This builder instance for method chaining
         */
         ...
         * <p>
         * The default value is 1000 (1 second). This is the amount of time to wait before
         * the first retry attempt. Subsequent retry attempts will use exponential backoff
         ...
         * <p>
         * The default value is 2.0. This means that each retry will wait twice as long as
         * the previous retry. For example, with an initial backoff of 1000ms and a multiplier
         ...
         * <p>
         * The default value is 10000 (10 seconds). This is the timeout for waiting for data
         ...
         * <p>
         * The default value is {@code true}. When set to {@code true}, the system will add
         * randomness to backoff times to prevent synchronized retry storms when multiple
